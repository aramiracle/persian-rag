...
```env
# --- APP CONFIGURATION ---
APP_NAME="Persian News RAG System (Scale)"
APP_VERSION=2.0.0
APP_DEBUG=true
APP_HOST=0.0.0.0
APP_PORT=8000
...
# --- MILVUS INDEXING (Optimized for Billions) ---
...
MILVUS_M=64
MILVUS_NBITS=8
# Prevent indexing on empty collections (min rows required)
MILVUS_INDEX_BUILD_THRESHOLD=100

# --- ELASTICSEARCH (BM25+ ENGINE) ---
...
EMBEDDING_RAM_SAFETY_MARGIN=0.2
EMBEDDING_WORKER_OVERHEAD_MB=350
